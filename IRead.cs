...
public interface IRead
{
    ...
    public static (int,int,string[][]) TwoDMenu_Function(string menuStatic_String, string[][] menuItems_ArrayString2D)
    {
    ...
    public static int OneDMenu_Function(string error_String, string[][] menuItems_ArrayString2D, int player_Int, int lastColumn_Int,string botInfo_String)
    {
    
        return KeyMenu_Function(error_String, menuItems_ArrayString2D, player_Int, lastColumn_Int, botInfo_String);
    ...
    private static (int,int,string[][]) KeyMenu_Function(string menuStatic_String, string[][] menuItems_ArrayString2D)
    {
        ...
        while(true)
        {
            ...
            hint_String =
                "Use Arrow Keys To Navigate, \"Enter\" To Select, \"E\" To Replace Element With New Value, \"Delete\"To Remove An Element, \"R\" To Revert All Changes, \"Escape\" To Go Back";
            ...
            switch (Console.ReadKey(true).Key)
            {
                ...
                case ConsoleKey.R:
                {
                    ...
                    System.Console.WriteLine("View Only, Revert To Initial Values? Press \"Y\" To Accept, Press \"N\" To Cancel");
    ...
    private static int KeyMenu_Function(string error_String, string[][] menuItems_ArrayString2D, int player_Int, int lastColumn_Int,string botInfo_String)
    {

        (int menuPointerColumn_Int, string hint_String) =
            (lastColumn_Int, $"Use Arrow Keys To Navigate, \"Enter\" To Select, \"Escape\": Main Menu)");
        ...
        while (true)
        {
            ...
            ShowMenu_Function(menuItems_ArrayString2D, menuPointerColumn_Int,-1,-1);
